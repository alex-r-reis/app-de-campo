...
window.salvarFotosVisitaNoCelular = salvarFotosVisitaNoCelular;
window.editarVisitaSalva = editarVisitaSalva;
...
async function aquecerCacheOffline() {
  ...
  const cache = await caches.open('ater-cacau-campo-v13');
  const urls = new Set([
    `${location.origin}/`,
